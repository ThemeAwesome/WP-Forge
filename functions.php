...
function wpforge_scripts() {
	global $wp_styles;
	  	wp_enqueue_style('wpforge_fonts', get_template_directory_uri() . '/fonts/fonts.css','', '6.3.0.1' );
			if( get_theme_mod( 'wpforge_select_css' ) == 'flex') {
				wp_enqueue_style('wpforge_foundation', get_template_directory_uri() . '/css/foundation-flex.css','', '6.3.0.1' );
			} else {
				wp_enqueue_style('wpforge_foundation', get_template_directory_uri() . '/css/foundation.css','', '6.3.0.1' );
			}
	  	wp_enqueue_style('wpforge_motion_ui', get_template_directory_uri() . '/css/motion-ui.css','', '1.2.2' );
	  	wp_enqueue_style('wpforge', get_stylesheet_uri(),'','6.3.0.1' );
}
...
if ( ! function_exists( 'wpforge_theme_functions' ) ) {
	function wpforge_theme_functions() {
		...
		wp_enqueue_script('wpforge_foundation', get_template_directory_uri() . '/js/foundation.js', array('jquery'),'6.3.0.1', true);
		wp_enqueue_script ('wpforge_load_foundation', get_template_directory_uri() . '/js/theme-functions.js', array('wpforge_foundation'), '6.3.0.1', true);
	}
